...
`
function Book(props){
    const {title,author,describe,onStock,addbook,id}=props
    const click=()=>{
        addbook(id);
    }
    return(
        <Container className="flex flex-col justify-between lg:w-1/5 md:w-5/12 w-3/4 my-9 rounded hover:scale-110 hover:shadow-white">
            ...
            <p className="mb-5 text-sm px-5">{describe}</p>
